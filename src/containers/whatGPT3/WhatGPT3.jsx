  ...
  return (
    <div className="gpt3__whatgpt3 section__margin" id="wgpt3">
       ...
       <div className="gpt3__whatgpt3-container">
          ...
          <Feature title="Knowledgebase" text="At jointure ladyship an insisted so humanity. Friendly bachelor entrance to on by. As put impossible own apartments" />
          <Feature title="Education" text="At jointure ladyship an insisted so humanity. Friendly bachelor entrance to on by. As put impossible own apartments" />
       </div>
    </div>
  )
}
